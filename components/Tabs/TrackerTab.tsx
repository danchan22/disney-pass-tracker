...
export const TrackerTab: React.FC<TrackerTabProps> = ({
  ...
  // --- COMPUTE TOP 3 MOST POPULAR RIDES ---
        ...
        <div>
          ...
          <div style={{ background: '#FFF', borderRadius: '24px', padding: '18px', marginBottom: '25px', boxShadow: '0 4px 20px rgba(0,0,0,0.04)', border: '1px solid #E2E8F0' }}>
            ...
            <div style={{ marginBottom: '18px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {top3Rides.length === 0 ? (
                  <div style={{ fontSize: '12px', color: '#A0AEC0', fontStyle: 'italic', padding: '8px 0' }}>
                    No rides logged yet.
                  </div>
                ) : (
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          padding: '12px 14px',
                          borderRadius: '16px',
                          background: isFirst ? '#FFFDF5' : '#F8FAFC',
                          border: isFirst ? '1px solid #D4AF37' : '1px solid #EDF2F7',
                          boxShadow: isFirst ? '0 2px 8px rgba(212, 175, 55, 0.15)' : 'none'
                        }}
                      >
                        <div>
                          <div style={{ fontWeight: '900', fontSize: '14px', color: '#004487' }}>
                            {ride.name}
                          </div>
                          <div style={{ fontSize: '11px', color: '#718096', marginTop: '2px' }}>
                        ...
                        <div style={{ fontSize: '16px', fontWeight: '900', color: '#004487', flexShrink: 0 }}>
                          {ride.count}x
                        </div>
                      </div>
                    );
