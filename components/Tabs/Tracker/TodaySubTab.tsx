...
export const TodaySubTab: React.FC<TodaySubTabProps> = ({
  ...
  useEffect(() => {
    ...
    updateDuration();
    const timer = setInterval(updateDuration, 30000);
  ...
  return (
    <div>
      ...
      {/* PARK HOPPING TOGGLE TEXT BUTTON */}
      {activeVisit && (
      ...
      {/* CHECK-IN FORM: Renders when no active visit exists OR when park hopping is toggled */}
      ...
      {activeVisit && <LiveWaitTimesWidget parkName={activeVisit.parkName} />}
